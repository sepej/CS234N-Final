...
{
    public partial class BITSEFContext : DbContext
    {
        public BITSEFContext()
        {
        }

        public BITSEFContext(DbContextOptions<BITSEFContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySQL("server=127.0.0.1;uid=root;pwd=JYbXtuewzOaPjhZxbfGc;database=bits");
            }
        }
